...
> ![Aperçu de l'interface mobile](./client/public/screenshot-mobile.webp) >_Aperçu de l'interface mobile_
>
> ![Aperçu de l'interface desktop](./client/public/screenshot-desktop.webp) >_Aperçu de l'interface desktop_
